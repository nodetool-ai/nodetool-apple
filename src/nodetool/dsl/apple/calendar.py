...
class CreateCalendarEvent(GraphNode):
    ...
    calendar_name: str | GraphNode | tuple[GraphNode, str] = Field(
    ...
    def get_node_type(cls):
        return "apple.calendar.CreateCalendarEvent"
...
class ListCalendarEvents(GraphNode):
    ...
    days_back: int | GraphNode | tuple[GraphNode, str] = Field(
        default=0, description="Number of days to look back from today"
    )
    days_forward: int | GraphNode | tuple[GraphNode, str] = Field(
    ...
    @classmethod
    def get_node_type(cls):
        return "apple.calendar.ListCalendarEvents"
